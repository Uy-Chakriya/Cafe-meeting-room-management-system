...
import org.springframework.context.annotation.ComponentScan; // ⬅️ NEW IMPORT

// ⬅️ NEW: Explicitly list all packages containing Spring components (controllers, services, security, repositories)
